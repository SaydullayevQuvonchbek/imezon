...
<title>Smenalar tarixi | IMezon Do'kon</title>
  ...
  <div class="im-table-wrap mb-3">
    <table class="im-table">
       ...
       <tbody>
         ...
         ${d.usd_qaytim > 0 ? `<tr>
           <td><i class="bi bi-dash-circle text-danger"></i> USD qaytimi (Sotuvda)</td>
           <td class="text-right text-danger num">-${fmt(d.usd_qaytim)}</td>
           <td></td><td></td><td></td>
         </tr>` : ''}
       </tbody>
    </table>
